...
void init_can(){
	...
	write_instruction(MCP_CNF1, 0x41); //01000001 SJW1, SJW0, BRP5, BRP4, BRP3, BRP2, BRP1, BRP0
	write_instruction(MCP_CNF2, 0xF1); //11110001 BTLMODE, SAM, PHSEG12, PHSEG11, PHSEG10, PRSEG2, PRSEG1, PRSEG0
	write_instruction(MCP_CNF3, 0x85); //10000101 SOF, WAKFIL, ___, ___, ___, PHSEG22, PHSEG21, PHSEG20
